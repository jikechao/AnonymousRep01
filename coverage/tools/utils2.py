...
class K_SectionNeuronCoverage(BaseCoverage):
    ...
    def update_coverage(self, **kwargs):
        ...
        singel_cover_section_num_100 = 0
        singel_cover_section_num_500 = 0
        ...
        for i, intermediate_layer_output in enumerate(intermediate_layer_outputs):
            for num_neuron in range(intermediate_layer_output.shape[-1]):
                ...
                cover_section_num_100 =cover_section_num_100 + singel_cover_section_num_100
                cover_section_num_500 = cover_section_num_500 + singel_cover_section_num_500
                singel_cover_section_num = 0
                singel_cover_section_num_100 = 0
                singel_cover_section_num_500 = 0
                ...
                for n in range(intermediate_layer_output.shape[0]):
                    ...
                    try:
                        ...
                        continue
                    if n == 100:
                        singel_cover_section_num_100 = singel_cover_section_num
                    if n == 500:
                        singel_cover_section_num_500 = singel_cover_section_num
